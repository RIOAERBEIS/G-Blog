		...
		<TBODY>
			<TR>
				<TD vAlign=top bgColor=#799ae1>
						...
						<TBODY>
							<TR>
								<TD class=menu_title onMouseOver="this.className='menu_title2';"
									...
									height=25><SPAN> | <A href="<%=basePath%>exit"
						...
						<TBODY>
							<TR>
								<TD class=menu_title id=menuTitle1
									...
									background=images/admin_left_1.gif height=25><span><B>个人资料</B></span></TD>
							</TR>
							<TR>
								<TD id=submenu0>
						...
						<TBODY>
							<TR>
								<TD class=menu_title id=menuTitle1
									...
									onmouseout="this.className='menu_title';"
									background=images/admin_left_2.gif height=25><SPAN>文章管理</SPAN>
								</TD>
							</TR>
							<TR>
								<TD id=submenu2><DIV class=sec_menu style="WIDTH: 158px">
										<TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
											<TBODY>
												<TR>
													<TD height=20><a
														href="<%=basePath%>adminarticle/toWriteArticle"
														target=mainFrame>写文章</a></TD>
												</TR>
												<TR>
													<TD height=20><a
														href="<%=basePath%>adminarticle/articleList"
														target="mainFrame">文章列表</a></TD>
												</TR>
												<!-- <TR>
					...
					</TABLE> <!-- <TABLE cellSpacing=0 cellPadding=0 width=158 align=center>
        <TBODY>
        <TR>
          <TD class=menu_title id=menuTitle1 
						...
						<TBODY>
							<TR>
								<TD class=menu_title id=menuTitle1
									...
									onmouseout="this.className='menu_title';"
									background=images/admin_left_2.gif height=25><SPAN>系统登录日志管理</SPAN>
								</TD>
							</TR>
							<TR>
								<TD id=submenu30>
						...
						<TBODY>
							<TR>
								<TD class=menu_title id=menuTitle1
									onmouseover="this.className='menu_title2';"
									onmouseout="this.className='menu_title';"
									background=images/admin_left_9.gif height=25><SPAN>博客管理版权信息</SPAN></TD>
							</TR>
							<TR>
								<TD>
									<DIV class=sec_menu style="WIDTH: 158px">
										<TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
											<TBODY>
												<TR>
													<TD height=20 bgcolor="#D6DFF7" style="LINE-HEIGHT: 150%">版权:xxxBlogs
														xingstar</TD>
												</TR>
											</TBODY>
										</TABLE>
